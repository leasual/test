...
public class CamerSer extends Service implements SurfaceHolder.Callback{
    ...
    private Camera openFrontFacingCameraGingerbread()
    {
        ...
        Camera cam = null;
        cam = Camera.open(0);
//        if (isFrontFacing && checkFrontCamera(CamerSer.this))
//        {
//            int cameraCount = 0;
//            cam = null;
...
//        }
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder)
    {
        ...
        if (!imagesFolder.exists())
            imagesFolder.mkdirs(); // <----
        Log.e("folder " , imagesFolder.getPath());
